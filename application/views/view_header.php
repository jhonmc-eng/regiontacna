...
<head>
    ...
    // If there is no value in language session id then set up the default database language id into the session language id
    if(!isset($_SESSION['sess_lang_id'])) {
        $lang = $CI->Model_lang->get_default_language_id();
        $_SESSION['sess_lang_id'] = $lang['lang_id'];
    }

    // Get all data by language session id
    $detail_arr = array();
    $detail_arr = $CI->Model_lang->get_detail_by_language_id($_SESSION['sess_lang_id']);
                ...
                <div class="col-lg-9 col-12 main-menu">
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <?php if( ($arr_menu[4] == 'Show') || ($arr_menu[5] == 'Show') || ($arr_menu[6] == 'Show') || ($arr_menu[7] == 'Show') || ($arr_menu[8] == 'Show') ): ?>

        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Acerca de</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Preguntas Frecuentes</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Servicios</a></li>
                        <li><a href="#tab_7" data-toggle="tab">Testimonios</a></li>
                        <li><a href="#tab_8" data-toggle="tab">Noticias</a></li>
                        <li><a href="#tab_16" data-toggle="tab">Eventos</a></li>
                        <li><a href="#tab_9" data-toggle="tab">Contáctenos</a></li>
                        <li><a href="#tab_10" data-toggle="tab">Buscar</a></li>
                        <li><a href="#tab_11" data-toggle="tab">Términos</a></li>
                        <li><a href="#tab_12" data-toggle="tab">Privacidad</a></li>
                        <li><a href="#tab_14" data-toggle="tab">Equipo</a></li>
                        <li><a href="#tab_15" data-toggle="tab">Portafolio</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home">Actualizar</button>
                                    </div>
                                </div>                 
                            <?php echo form_close(); ?>

                            <h3 class="sec_title">Sección de Bienvenida</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="home_welcome_text" class="form-control editor" cols="30" rows="10"><?php echo $page_home['home_welcome_text']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_welcome">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            
                            <h3 class="sec_title">Sección de bienvenida (fondo de video)</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Fondo de video existente</label>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Fondo de video </label>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_welcome_video_bg">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Por qué elegirnos sección</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_why_choose_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_why_choose_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_why_choose">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Sección de características</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_feature_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_feature_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_feature">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Sección de servicio</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_service_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_service_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_service">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>

                            <h3 class="sec_title">Sección de información del mostrador</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Item 1 - Título </label>
                                    <div class="col-sm-2">
                                    ...
                                    <label for="" class="col-sm-2 control-label">Item 1 - Icono </label>
                                    <div class="col-sm-2">
                                        <input type="text" name="counter_1_icon" class="form-control" value="<?php echo $page_home['counter_1_icon']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Item 2 - Título </label>
                                    <div class="col-sm-2">
                                    ...
                                    <label for="" class="col-sm-2 control-label">Item 2 - Icono </label>
                                    <div class="col-sm-2">
                                        <input type="text" name="counter_2_icon" class="form-control" value="<?php echo $page_home['counter_2_icon']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Item 3 - Título </label>
                                    <div class="col-sm-2">
                                    ...
                                    <label for="" class="col-sm-2 control-label">Item 3 - Icono </label>
                                    <div class="col-sm-2">
                                        <input type="text" name="counter_3_icon" class="form-control" value="<?php echo $page_home['counter_3_icon']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Item 4 - Título </label>
                                    <div class="col-sm-2">
                                    ...
                                    <label for="" class="col-sm-2 control-label">Item 4 - Icono </label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="counter_status" class="form-control select2" style="width:auto;">
                                            <option value="Show" <?php if($page_home['counter_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                            <option value="Hide" <?php if($page_home['counter_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_counter_text">Actualizar</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>

                            <h3 class="sec_title">Sección de fotos de mostrador</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Fondo de contador existente</label>
                                    <div class="col-sm-6" style="padding-top:6px;">
                                        <img src="<?php echo base_url(); ?>public/uploads/<?php echo $page_home['counter_photo']; ?>" class="existing-photo" style="height:180px;">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Nuevo fondo de contador</label>
                                    <div class="col-sm-6" style="padding-top:6px;">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_counter_photo">Actualizar</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>


                            <h3 class="sec_title">Sección de Portafolio</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_portfolio_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_portfolio_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_portfolio">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Sección de reserva</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título del formulario de reserva </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_booking_form_title" class="form-control" value="<?php echo $page_home['home_booking_form_title']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título de las preguntas frecuentes sobre reservas </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_booking_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_booking_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_booking">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Sección de fotos de reserva</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Sección de fotos de reserva</label>
                                    <div class="col-sm-6" style="padding-top:6px;">
                                        <img src="<?php echo base_url(); ?>public/uploads/<?php echo $page_home['home_booking_photo']; ?>" class="existing-photo" style="height:180px;">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Nuevo fondo de reserva</label>
                                    <div class="col-sm-6" style="padding-top:6px;">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_booking_photo">Actualizar</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Sección del Equipo</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_team_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_team_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_team">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Sección de la tabla de precios</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_ptable_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_ptable_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_pricing_table">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Sección de Testimonios</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_testimonial_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_testimonial_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_testimonial">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>

                            <h3 class="sec_title">Sección de fotos testimoniales</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_testimonial_photo">Actualizar</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>


                            <h3 class="sec_title">Sección del Blog</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_blog_status'] == 'Show') {echo 'selected';} ?>>Mostrar</option>
                                        <option value="Hide" <?php if($page_home['home_blog_status'] == 'Hide') {echo 'selected';} ?>>Ocultar</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_blog">Actualizar</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                        ...
                        <div class="tab-pane" id="tab_2">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="about_content" class="form-control editor" cols="30" rows="10"><?php echo $page_about['about_content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título para Google</label>
                        ...
                        <div class="tab-pane" id="tab_5">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">SEO Palabras Clave </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_service">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_7">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera Testimonio </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_testimonial">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_8">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera de Noticias </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_news">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_16">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera de Eventos </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_event">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_9">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera de Contacto </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Correo Electrónico de Contacto </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Ubicación de Contacto (Código iFrame) </label>
                                    <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_10">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera de Búsqueda </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_search">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_11">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera Términos y Condiciones </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="term_heading" class="form-control" value="<?php echo $page_term['term_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Contenido Términos y Condiciones </label>
                                    <div class="col-sm-9">
                                        <textarea name="term_content" class="form-control editor" cols="30" rows="10"><?php echo $page_term['term_content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título para Google</label>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_term">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_12">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera Política de Privacidad </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="privacy_heading" class="form-control" value="<?php echo $page_privacy['privacy_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Contenido Política de Privacidad </label>
                                    <div class="col-sm-9">
                                        <textarea name="privacy_content" class="form-control editor" cols="30" rows="10"><?php echo $page_privacy['privacy_content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Título para Google</label>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_privacy">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_14">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera de Equipo </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_team">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_15">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Cabecera de Portafolio </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_portfolio">Actualizar</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>

<aside class="control-sidebar control-sidebar-dark">
	...
	<script src="<?php echo base_url(); ?>public/admin/daterangepicker/daterangepicker.js"></script>
	<script src="<?php echo base_url(); ?>public/admin/datepicker/bootstrap-datepicker.js"></script>
	<script src="<?php echo base_url(); ?>public/admin/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
	<script src="<?php echo base_url(); ?>public/admin/knob/jquery.knob.js"></script>
	<script src="<?php echo base_url(); ?>public/admin/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="<?php echo base_url(); ?>public/admin/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<script src="<?php echo base_url(); ?>public/admin/morris/morris.min.js"></script>

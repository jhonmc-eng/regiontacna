							...
							foreach ($partner as $row) {
								...
								<tr>
									...
									<td>										
										...
										<a href="#" class="btn btn-danger btn-xs" data-href="<?php echo base_url(); ?>admin/partner/delete/<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Borrar</a>  
									</td>
								</tr>
								<?php
							}

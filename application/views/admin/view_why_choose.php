...
<section class="content-header">
	<div class="content-header-left">
		<h1>Ver por qué elegirnos</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/why_choose/add" class="btn btn-primary btn-sm">Agregar Nuevo</a>
	</div>
</section>
							...
							foreach ($why_choose as $row) {
								...
								<tr>
									...
									<td>
										...
										<a href="<?php echo base_url(); ?>admin/why_choose/delete/<?php echo $row['id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Deseas Eliminar Realmente?');">Borrar</a> 
									</td>
								</tr>
								<?php
							}

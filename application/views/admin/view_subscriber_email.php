...
<section class="content-header">
	<div class="content-header-left">
		<h1>Enviar Correo a Suscriptores</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/subscriber" class="btn btn-primary btn-sm">Ver Todo</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Enviar Correo</button>
							</div>
						</div>
					</div>
				</div>

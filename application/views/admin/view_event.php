...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/event/add" class="btn btn-primary btn-sm">Agregar Nuevo</a>
	</div>
</section>
					...
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th>Foto</th>
								<th>Banner</th>
								<th style="width:60px;">Fecha de inicio</th>
								<th style="width:60px;">Fecha de termino</th>
								<th>Estado</th>
							...
							foreach ($event as $row) {
								...
								<tr>
									...
									<td>										
										...
										<a href="<?php echo base_url(); ?>admin/event/delete/<?php echo $row['event_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Deseas Eliminar Realmente?');">Borrar</a>  
									</td>
								</tr>
								<?php
							}

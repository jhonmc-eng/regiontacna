...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/faq" class="btn btn-primary btn-sm">Ver Todo</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Pregunta<span>*</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Ver en Menú? <span>*</span></label>
							<div class="col-sm-2">
								<select name="show_on_home" class="form-control select2">
									<option value="Yes" <?php if($faq['show_on_home'] == 'Yes') {echo 'selected';} ?>>Si</option>

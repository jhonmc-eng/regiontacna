				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control editor" name="short_content" style="height:100px;"><?php if(isset($_POST['short_content'])){echo $_POST['short_content'];} ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control editor" name="client_comment" style="height:250px;"><?php if(isset($_POST['client_comment'])){echo $_POST['client_comment'];} ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Foto Publicada*</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Otras fotos</label>

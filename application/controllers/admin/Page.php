...
class Page extends CI_Controller 
{
	...
	public function update()
	{
		...
		if(isset($_POST['form_home_welcome'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = '¡La información de bienvenida de la página de inicio se ha actualizado correctamente!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_welcome_video_bg'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'El fondo del vídeo de bienvenida de la página de inicio se ha actualizado correctamente!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		...
		if(isset($_POST['form_home_why_choose'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Página de inicio por qué elegirnos la información se actualiza correctamente!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_feature'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'La información de las funciones de la página de inicio se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_service'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'La información de servicio de la página de inicio se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_counter_text'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = '¡La información del contador de la página de inicio se ha actualizado correctamente!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_counter_photo'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = '¡La foto del contador de la página de inicio se ha actualizado correctamente!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_home_booking_photo'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = '¡La foto de reserva de la página de inicio se ha actualizado correctamente!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_home_portfolio'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = '¡La información de la cartera de la página de inicio se ha actualizado correctamente!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_booking'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = '¡La información de reserva de la página de inicio se ha actualizado correctamente!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_team'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'La información del equipo de la página de inicio se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_pricing_table'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = '¡La información de la tabla de precios de la página de inicio se ha actualizado correctamente!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_testimonial'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'La información de testimonios de la página de inicio se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_testimonial_photo'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = '¡La foto testimonial de la página de inicio se ha actualizado correctamente!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_home_blog'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'La información del blog de la página de inicio se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_about'])) {
        	...
        	$success = 'Acerca de la configuración de la página se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_faq'])) {
        	...
        	$success = 'La configuración de la página de preguntas frecuentes se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_service'])) {
        	...
        	$success = 'La configuración de la página de servicio se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_testimonial'])) {
        	...
        	$success = 'La configuración de la página de testimonios se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_news'])) {
        	...
        	$success = 'La configuración de la página de noticias se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_event'])) {
        	...
        	$success = '¡La configuración de la página del evento se ha actualizado correctamente!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_contact'])) {
        	...
        	$success = 'La configuración de la página de contacto se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_search'])) {
        	...
        	$success = 'La configuración de la página de búsqueda se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_term'])) {
        	...
        	$success = 'La configuración de la página de término se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_privacy'])) {
        	...
        	$success = 'La configuración de la página de privacidad se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_team'])) {
        	...
        	$success = 'La configuración de la página del equipo se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_portfolio'])) {
        	...
        	$success = 'La configuración de la página de la cartera se ha actualizado correctamente.';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}

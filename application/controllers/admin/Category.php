...
class Category extends CI_Controller 
{
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($path!='') {
		    	...
		    	$valid = 0;
		        $error .= 'Tienes que seleccionar una foto for banner<br>';
		    }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    if($valid == 1) 
		    {
				...
				$success = 'Categoria Actualziado Correctamente';
				$this->session->set_flashdata('success',$success);
				redirect(base_url().'admin/category');
		    }
		    else
	...
	public function delete($id) 
	{
    	...
    	if($status) 
    	{
    		$error = 'Esta Categoria no puede ser borrada por que se encuentra en uso';
    		$this->session->set_flashdata('error',$error);
    		redirect(base_url().'admin/category');
    	}
    	else
    	{
	        ...
	        $success = 'Categoria Borrada Correctamente';
	        $this->session->set_flashdata('success',$success);
	        redirect(base_url().'admin/category');
    	}    	
    }
